...
public class Result_Acitvity extends AppCompatActivity {
    ...
    private void initJamur()
    {
        ...
        LisJamurList.add(j);
        j = new Jamur(9,"Jamur Maitake (Grifola frondosa)","Tidak berbau","Tidak ada","Tidak","kayu mati","des","jamur_maitake",0,"hitam","cuping");
        LisJamurList.add(j);
        j = new Jamur(10,"Jamur Bulan (Gymnopus sp)","Tidak berbau","Tidak ada","Tidak","tanah","des","jamur_bulan",0,"kuning semu","tudung cembung");
        LisJamurList.add(j);
        j = new Jamur(11,"Jamur Bulat (Lycoperdun perlatum)","Tidak berbau","Tidak ada","Tidak","padang rumput","des","jamur_bulat",0,"putih","bulat");
        LisJamurList.add(j);
        j = new Jamur(12,"Jamur barat (Clitocybe nebularis)","Bau","Tidak ada","Tidak","tanah","des","jamur_barat",0,"coklat semu","tudung cembung");
        LisJamurList.add(j);
        j = new Jamur(13,"Jamur Ling Zhi (Ganoderma lucidum)","Tidak berbau","Tidak ada","Tidak","kayu mati","des","jamur_lingzhi",0,"coklat","tudung serong");
        LisJamurList.add(j);
        j = new Jamur(14,"Jamur chanterelle (Cantharellus cibarius)","Bau","Tidak ada","Tidak","tanah","des","jamur_chanterelle",0,"kuning","corong");
        LisJamurList.add(j);
        ...
        LisJamurList.add(j);
        j = new Jamur(16,"Jamur surai singa (Hericium erinaceus)","Tidak berbau","Tidak ada","Tidak","kayu mati","des","jamur_surai_singa",0,"kuning semu","rumbai");
        LisJamurList.add(j);
        j = new Jamur(17,"Jamur matsutake (Tricholoma matsutake)","Bau","Ada","Tidak","dasar pohon","des","jamur_matsutake",0,"coklat","tudung cembung");
        LisJamurList.add(j);
        j = new Jamur(18,"Jamur Amanita (Amanita muscaria)","Tidak berbau","Ada","Tidak","dasar pohon","des","jamur_amanita",0,"merah bintik","tudung cembung");
        LisJamurList.add(j);
